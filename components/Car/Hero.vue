...
<template>
  <div
    class="relative bg-[url('https://carconfigurator.ferrari.com/assets/cars/portofinom/packages/default/car-ferrari-portofino-m_splash.jpg')] h-screen w-100 bg-no-repeat bg-cover bg-bottom"
  >
